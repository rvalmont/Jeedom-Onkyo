...
function addCmdToTable(_cmd) {
	...
	var tr = '<tr class="cmd" data-cmd_id="' + init(_cmd.id) + '">';
		...
		tr += '<td><span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-l1key="isVisible" checked/>{{Afficher}}</label>';
		if (_cmd.type == 'info') {
			tr += '<br><label class="checkbox-inline"><input type="checkbox" class="cmdAttr checkbox-inline" data-size="mini" data-l1key="isHistorized" checked/>{{Historiser}}</label>';
		}
